...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2021 at 11:42 AM
...
CREATE TABLE `company` (
  ...
  `stock_pe` double DEFAULT NULL,
  `dividend_yield` double DEFAULT NULL,
  `roce_per` double DEFAULT NULL,
  `roe_pre_annum` double DEFAULT NULL,
  `debit_equity` double DEFAULT NULL,
...
INSERT INTO `company` (`company_id`, `company_name`, `market_price`, `market_cap`, `stock_pe`, `dividend_yield`, `roce_per`, `roe_pre_annum`, `debit_equity`, `eps`, `reserves`, `debt`) VALUES
